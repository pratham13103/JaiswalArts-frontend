    ...
    <div>
      ...
      <section className="relative h-[90vh] flex flex-col items-center justify-center text-center">
        ...
        <div className="relative z-10 text-white px-6">
          ...
          >
            <a href="/products" className="px-6 py-3 text-lg font-semibold bg-red-600 hover:bg-orange-500 text-white rounded-lg transition-all">
              Explore Artworks
            </a>
            <a href="/custom-orders" className="px-6 py-3 text-lg font-semibold border border-white hover:bg-white hover:text-black rounded-lg transition-all">
              Custom Orders
            </a>
          </motion.div>
        </div>
